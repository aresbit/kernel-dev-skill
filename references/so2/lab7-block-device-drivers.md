...
<div role="navigation" aria-label="Page navigation">
  ...
  - [Operating Systems 2](index.html)
  - SO2 Lab 07 - Block Device Drivers
  - [View page source](../_sources/so2/lab7-block-device-drivers.rst.txt)
...
<div id="so2-lab-07-block-device-drivers" class="section">

# SO2 Lab 07 - Block Device Drivers[¶](#so2-lab-07-block-device-drivers "Permalink to this headline")
...
Review the sections [<span class="std std-ref">How to use the content of a struct bio structure</span>](#bio-content) and [<span class="std std-ref">Wait for the completion of a struct bio structure</span>](#bio-completion).
...
Review the indications and the code snippets from the [<span class="std std-ref">How to use the content of a struct bio structure</span>](#bio-content) section.
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](lab6-memory-mapping.html "SO2 Lab 06 - Memory Mapping") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](lab8-filesystems-part1.html "SO2 Lab 08 - File system drivers (Part 1)")
