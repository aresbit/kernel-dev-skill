...
<div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="Navigation menu">
  ...
  - [Operating Systems 2](index.html)
      ...
      - [SO2 Lecture 01 - Course overview and Linux kernel introduction](#)
          - [Echipa](#echipa)
          - [Poziționare curs](#pozitionare-curs)
          - [Resurse](#resurse)
          - [Comunitate](#comunitate)
          - [Notare](#notare)
          - [Obiectivele cursului](#obiectivele-cursului)
          - [Obiectivele laboratorului si a temelor](#obiectivele-laboratorului-si-a-temelor)
          - [Cursuri necesare](#cursuri-necesare)
          - [Despre curs](#despre-curs)
          - [Lista cursuri](#lista-cursuri)
          - [Despre laborator](#despre-laborator)
          - [Despre teme](#despre-teme)
          - [Lista teme](#lista-teme)
          - [Bibliografie curs](#bibliografie-curs)
          - [Bibliografie laborator](#bibliografie-laborator)
          - [Lecture objectives:](#lecture-objectives)
          - [Basic operating systems terms and concepts](#basic-operating-systems-terms-and-concepts)
              - [User vs Kernel](#user-vs-kernel)
              - [Typical operating system architecture](#typical-operating-system-architecture)
              - [Monolithic kernel](#monolithic-kernel)
              - [Micro kernel](#micro-kernel)
              - [Micro-kernels vs monolithic kernels](#micro-kernels-vs-monolithic-kernels)
              - [Address space](#address-space)
              - [User and kernel sharing the virtual address space](#user-and-kernel-sharing-the-virtual-address-space)
              - [Execution contexts](#execution-contexts)
              - [Multi-tasking](#multi-tasking)
              - [Preemptive kernel](#preemptive-kernel)
              - [Pageable kernel memory](#pageable-kernel-memory)
              - [Kernel stack](#kernel-stack)
              - [Portability](#portability)
              - [Asymmetric MultiProcessing (ASMP)](#asymmetric-multiprocessing-asmp)
              - [Symmetric MultiProcessing (SMP)](#symmetric-multiprocessing-smp)
              - [CPU Scalability](#cpu-scalability)
          - [Overview of the Linux kernel](#overview-of-the-linux-kernel)
              - [Linux development model](#linux-development-model)
              - [Maintainer hierarchy](#maintainer-hierarchy)
              - [Linux source code layout](#linux-source-code-layout)
...
<div role="navigation" aria-label="Page navigation">
  ...
  - [Operating Systems 2](index.html)
  - SO2 Lecture 01 - Course overview and Linux kernel introduction
  - [View page source](../_sources/so2/lec1-intro.rst.txt)
...
<div id="so2-lecture-01-course-overview-and-linux-kernel-introduction" class="section">

# SO2 Lecture 01 - Course overview and Linux kernel introduction[¶](#so2-lecture-01-course-overview-and-linux-kernel-introduction "Permalink to this headline")

[View slides](lec1-intro-slides.html)

<span class="admonition-so2-lecture-01-course-overview-and-linux-kernel-introduction"></span>

<div id="echipa" class="section">

## Echipa[¶](#echipa "Permalink to this headline")
...
<div id="pozitionare-curs" class="section">

## Poziționare curs[¶](#pozitionare-curs "Permalink to this headline")

![../\_images/ditaa-fbe06955ffc165cbdc9cb6074abf0db807b3c5cd.png](../_images/ditaa-fbe06955ffc165cbdc9cb6074abf0db807b3c5cd.png)

</div>

<div id="resurse" class="section">

## Resurse[¶](#resurse "Permalink to this headline")
...
<div id="comunitate" class="section">

## Comunitate[¶](#comunitate "Permalink to this headline")
...
<div id="notare" class="section">

## Notare[¶](#notare "Permalink to this headline")
...
<div id="obiectivele-cursului" class="section">

## Obiectivele cursului[¶](#obiectivele-cursului "Permalink to this headline")
...
<div id="obiectivele-laboratorului-si-a-temelor" class="section">

## Obiectivele laboratorului si a temelor[¶](#obiectivele-laboratorului-si-a-temelor "Permalink to this headline")
...
<div id="cursuri-necesare" class="section">

## Cursuri necesare[¶](#cursuri-necesare "Permalink to this headline")
...
<div id="despre-curs" class="section">

## Despre curs[¶](#despre-curs "Permalink to this headline")
...
<div id="lista-cursuri" class="section">

## Lista cursuri[¶](#lista-cursuri "Permalink to this headline")
...
<div id="despre-laborator" class="section">

## Despre laborator[¶](#despre-laborator "Permalink to this headline")
...
<div id="despre-teme" class="section">

## Despre teme[¶](#despre-teme "Permalink to this headline")
...
<div id="lista-teme" class="section">

## Lista teme[¶](#lista-teme "Permalink to this headline")
...
<div id="bibliografie-curs" class="section">

## Bibliografie curs[¶](#bibliografie-curs "Permalink to this headline")
...
<div id="bibliografie-laborator" class="section">

## Bibliografie laborator[¶](#bibliografie-laborator "Permalink to this headline")
...
<div id="basic-operating-systems-terms-and-concepts" class="section">

## Basic operating systems terms and concepts[¶](#basic-operating-systems-terms-and-concepts "Permalink to this headline")

<div id="user-vs-kernel" class="section">

### User vs Kernel[¶](#user-vs-kernel "Permalink to this headline")

<span class="admonition-user-vs-kernel"></span>
...
User mode and kernel mode are terms that may refer specifically to the processor execution mode. Code that runs in kernel mode can fully [\[1\]](#hypervisor) control the CPU while code that runs in user mode has certain limitations. For example, local CPU interrupts can only be disabled or enable while running in kernel mode. If such an operation is attempted while running in user mode an exception will be generated and the kernel will take over to handle it.

|                                |                                                                                                                                                                             |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [\[1\]](#footnote-reference-1) | some processors may have even higher privileges than kernel mode, e.g. a hypervisor mode, that is only accessible to code running in a hypervisor (virtual machine monitor) |
...
<div id="typical-operating-system-architecture" class="section">

### Typical operating system architecture[¶](#typical-operating-system-architecture "Permalink to this headline")
...
<div id="monolithic-kernel" class="section">

### Monolithic kernel[¶](#monolithic-kernel "Permalink to this headline")
...
<div id="micro-kernel" class="section">

### Micro kernel[¶](#micro-kernel "Permalink to this headline")
...
This architecture imposes a modular approach to the kernel and offers memory protection between services but at a cost of performance. What is a simple function call between two services on monolithic kernels now requires going through IPC and scheduling which will incur a performance penalty [\[2\]](#minix-vs-linux).

|                                |                                    |
| ------------------------------ | ---------------------------------- |
| [\[2\]](#footnote-reference-2) | <https://lwn.net/Articles/220255/> |

</div>

<div id="micro-kernels-vs-monolithic-kernels" class="section">

### Micro-kernels vs monolithic kernels[¶](#micro-kernels-vs-monolithic-kernels "Permalink to this headline")
...
<span class="admonition-address-space"></span>
...
<div id="user-and-kernel-sharing-the-virtual-address-space" class="section">

### User and kernel sharing the virtual address space[¶](#user-and-kernel-sharing-the-virtual-address-space "Permalink to this headline")
...
<div id="execution-contexts" class="section">

### Execution contexts[¶](#execution-contexts "Permalink to this headline")

<span class="admonition-execution-contexts"></span>
...
<div id="multi-tasking" class="section">

### Multi-tasking[¶](#multi-tasking "Permalink to this headline")

<span class="admonition-multi-tasking"></span>
...
<div id="pageable-kernel-memory" class="section">

### Pageable kernel memory[¶](#pageable-kernel-memory "Permalink to this headline")
...
<div id="kernel-stack" class="section">

### Kernel stack[¶](#kernel-stack "Permalink to this headline")
...
<div id="portability" class="section">

### Portability[¶](#portability "Permalink to this headline")
...
<div id="asymmetric-multiprocessing-asmp" class="section">

### Asymmetric MultiProcessing (ASMP)[¶](#asymmetric-multiprocessing-asmp "Permalink to this headline")
...
<div id="symmetric-multiprocessing-smp" class="section">

### Symmetric MultiProcessing (SMP)[¶](#symmetric-multiprocessing-smp "Permalink to this headline")
...
<div id="cpu-scalability" class="section">

### CPU Scalability[¶](#cpu-scalability "Permalink to this headline")
...
<div id="overview-of-the-linux-kernel" class="section">

## Overview of the Linux kernel[¶](#overview-of-the-linux-kernel "Permalink to this headline")

<div id="linux-development-model" class="section">

### Linux development model[¶](#linux-development-model "Permalink to this headline")

<span class="admonition-linux-development-model"></span>
...
<div id="maintainer-hierarchy" class="section">

### Maintainer hierarchy[¶](#maintainer-hierarchy "Permalink to this headline")
...
<div id="linux-source-code-layout" class="section">

### Linux source code layout[¶](#linux-source-code-layout "Permalink to this headline")
...
<div id="linux-kernel-architecture" class="section">

### Linux kernel architecture[¶](#linux-kernel-architecture "Permalink to this headline")
...
#### arch[¶](#arch "Permalink to this headline")
...
<div id="device-drivers" class="section">

#### Device drivers[¶](#device-drivers "Permalink to this headline")

<span class="admonition-device-drivers"></span>
...
<div id="process-management" class="section">

#### Process management[¶](#process-management "Permalink to this headline")

<span class="admonition-process-management"></span>
...
<div id="block-i-o-management" class="section">

#### Block I/O management[¶](#block-i-o-management "Permalink to this headline")
...
<div id="virtual-filesystem-switch" class="section">

#### Virtual Filesystem Switch[¶](#virtual-filesystem-switch "Permalink to this headline")
...
<div id="networking-stack" class="section">

#### Networking stack[¶](#networking-stack "Permalink to this headline")
...
<div id="linux-security-modules" class="section">

#### Linux Security Modules[¶](#linux-security-modules "Permalink to this headline")
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](grading.html "SO2 - General Rules and Grading") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](lec2-syscalls.html "SO2 Lecture 02 - System calls")
