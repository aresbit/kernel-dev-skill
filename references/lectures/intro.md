  ...
  - [Introduction](#)
      ...
      - [Overview of the Linux kernel](#overview-of-the-linux-kernel)
          ...
          - [Linux kernel architecture](#linux-kernel-architecture)
              ...
              - [Block I/O management](#block-i-o-management)
              - [Virtual Filesystem Switch](#virtual-filesystem-switch)
...
<div role="navigation" aria-label="Page navigation">
  ...
  - [](../index.html)
  - Introduction
  - [View page source](../_sources/lectures/intro.rst.txt)
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](../so2/assign7-kvm-vmm.html "Assignment 7 - SO2 Virtual Machine Manager with KVM") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](syscalls.html "System Calls")
