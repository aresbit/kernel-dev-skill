...
<span class="caption-text">Labs</span>
  ...
  - [Linux Device Model](#)
      - [Overview](#overview)
      - [sysfs](#sysfs)
      - [Basic Structures in Linux Devices](#basic-structures-in-linux-devices)
          - [The kobject structure](#the-kobject-structure)
          - [Buses](#buses)
          - [Devices](#devices)
          - [Drivers](#drivers)
          - [Classes](#classes)
      ...
      - [Exercises](#exercises)
          - [0. Intro](#intro)
          - [1. Bus implementation](#bus-implementation)
          - [2. Add type and version device attributes](#add-type-and-version-device-attributes)
          - [3. Add del and add bus attributes](#add-del-and-add-bus-attributes)
          - [4. Register the bex misc driver](#register-the-bex-misc-driver)
          - [5. Register misc device in the bex\_misc probe function](#register-misc-device-in-the-bex-misc-probe-function)
          - [6. Monitor uevent notifications](#monitor-uevent-notifications)
...
<div role="navigation" aria-label="Page navigation">
  ...
  - [](../index.html)
  - Linux Device Model
  - [View page source](../_sources/labs/device_model.rst.txt)
...
<div id="linux-device-model" class="section">

# Linux Device Model[¶](#linux-device-model "Permalink to this headline")
...
<div id="sysfs" class="section">

## sysfs[¶](#sysfs "Permalink to this headline")
...
![../\_images/ditaa-a5f399cb84561893770eb45ceeb827ce6d4a2336.png](../_images/ditaa-a5f399cb84561893770eb45ceeb827ce6d4a2336.png)

</div>

<div id="basic-structures-in-linux-devices" class="section">

## Basic Structures in Linux Devices[¶](#basic-structures-in-linux-devices "Permalink to this headline")
...
![../\_images/ditaa-f7ee56960e76c3e80fcbe59fafa38c3d93eac261.png](../_images/ditaa-f7ee56960e76c3e80fcbe59fafa38c3d93eac261.png)

<div id="the-kobject-structure" class="section">

### The kobject structure[¶](#the-kobject-structure "Permalink to this headline")
...
### Buses[¶](#buses "Permalink to this headline")
...
The functions that will normally be initialized within a bus\_type structure are `match` and `uevent`:
...
The Linux Device Model interface allows you to create attributes for the associated objects. These attributes will have a corresponding file in the bus subdirectory in sysfs. The attributes associated with a bus are described by the bus\_attribute structure :
...
### Drivers[¶](#drivers "Permalink to this headline")
...
Rules for `udev` are located `/etc/udev/rules.d`. Any file that ends with `.rules` in this directory will be parsed when an event occurs. For more details on how to write rules in these files see [Writing udev rules](http://www.reactivated.net/writing_udev_rules.html). For testing, there are utilities such as `udevmonitor`, `udevinfo` and `udevtest`.
...
<div id="plug-and-play" class="section">

## Plug and Play[¶](#plug-and-play "Permalink to this headline")
...
<div id="pnp-bus" class="section">

### PNP bus[¶](#pnp-bus "Permalink to this headline")
...
<div id="pnp-operations" class="section">

### PNP operations[¶](#pnp-operations "Permalink to this headline")
...
![../\_images/ditaa-4e1f9758808dba9e61bc0e48faf4365d377f9d32.png](../_images/ditaa-4e1f9758808dba9e61bc0e48faf4365d377f9d32.png)

</div>

<div id="adding-a-driver" class="section">

### Adding a driver[¶](#adding-a-driver "Permalink to this headline")
...
<div id="removing-a-driver" class="section">

### Removing a driver[¶](#removing-a-driver "Permalink to this headline")
...
<div id="adding-a-new-device" class="section">

### Adding a new device[¶](#adding-a-new-device "Permalink to this headline")
...
<div id="removing-a-device" class="section">

### Removing a device[¶](#removing-a-device "Permalink to this headline")
...
The current lab name is device\_model. See the exercises for the task name.
...
The modules are placed in /home/root/skels/device\_model/\<task\_name\>.
...
<div id="bus-implementation" class="section">

### 1\. Bus implementation[¶](#bus-implementation "Permalink to this headline")
...
<div id="add-type-and-version-device-attributes" class="section">

### 2\. Add type and version device attributes[¶](#add-type-and-version-device-attributes "Permalink to this headline")
...
<div id="add-del-and-add-bus-attributes" class="section">

### 3\. Add del and add bus attributes[¶](#add-del-and-add-bus-attributes "Permalink to this headline")

Add two write-only bus attributes, `del` and `add`. del expects the name of a device to delete, while add expects the name, type and version to create a new device. Follow the **TODO 3** markings and review [Buses](#buses).
...
<div id="register-the-bex-misc-driver" class="section">

### 4\. Register the bex misc driver[¶](#register-the-bex-misc-driver "Permalink to this headline")
...
<div id="register-misc-device-in-the-bex-misc-probe-function" class="section">

### 5\. Register misc device in the bex\_misc probe function[¶](#register-misc-device-in-the-bex-misc-probe-function "Permalink to this headline")

Modify **bex\_misc.c** to refuse probing if `version > 1`. Also, register the defined misc device in `bex_misc_probe` and deregister it in `bex_misc_remove`. Follow the **TODO 6** markings.
...
<div id="monitor-uevent-notifications" class="section">

### 6\. Monitor uevent notifications[¶](#monitor-uevent-notifications "Permalink to this headline")
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](memory_mapping.html "Memory mapping") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](kernel_profiling.html "Kernel Profiling")
