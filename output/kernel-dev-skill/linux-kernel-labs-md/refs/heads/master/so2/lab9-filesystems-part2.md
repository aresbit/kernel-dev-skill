...
<div role="navigation" aria-label="Page navigation">
  ...
  - [Operating Systems 2](index.html)
  - SO2 Lab 09 - File system drivers (Part 2)
  - [View page source](../_sources/so2/lab9-filesystems-part2.rst.txt)
...
<div id="so2-lab-09-file-system-drivers-part-2" class="section">

# SO2 Lab 09 - File system drivers (Part 2)[¶](#so2-lab-09-file-system-drivers-part-2 "Permalink to this headline")
...
Read the section [<span class="std std-ref">Directory inodes operations</span>](#directoryinodes)
...
Read the section [<span class="std std-ref">Regular files inode operations</span>](#fileoperations).
...
Read the section [<span class="std std-ref">Address space operations</span>](#addressspaceoperations).
...
![../\_images/minfs\_arch1.png](../_images/minfs_arch1.png)
...
Use the `minix_new_inode()` function as a model. Find the first free inode in imap (`sbi->imap`). Use bitwise operations (`find_first_zero_bit` and `set_bit`). Read the [<span class="std std-ref">Bitmap operations</span>](#bitmapoperations) section.
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](lab8-filesystems-part1.html "SO2 Lab 08 - File system drivers (Part 1)") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](lab10-networking.html "SO2 Lab 10 - Networking")
