...
<div role="navigation" aria-label="Page navigation">
  ...
  - [Operating Systems 2](index.html)
  - SO2 Lab 05 - Deferred work
  - [View page source](../_sources/so2/lab5-deferred-work.rst.txt)
...
<div id="so2-lab-05-deferred-work" class="section">

# SO2 Lab 05 - Deferred work[¶](#so2-lab-05-deferred-work "Permalink to this headline")
...
Review [<span class="std std-ref">ioctl</span>](lab3-device-drivers.html#ioctl) for a way to access the ioctl argument.
...
Use atomic variables for flags. Review [<span class="std std-ref">Atomic variables</span>](lab2-kernel-api.html#atomic-variables).
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](lab4-interrupts.html "SO2 Lab 04 - I/O access and Interrupts") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](lab6-memory-mapping.html "SO2 Lab 06 - Memory Mapping")
