...
<div role="navigation" aria-label="Page navigation">
  ...
  - [Operating Systems 2](index.html)
  - SO2 Lab 02 - Kernel API
  - [View page source](../_sources/so2/lab2-kernel-api.rst.txt)
...
<div id="so2-lab-02-kernel-api" class="section">

# SO2 Lab 02 - Kernel API[¶](#so2-lab-02-kernel-api "Permalink to this headline")
...
[![../\_images/list\_evolution1.png](../_images/list_evolution1.png)](../_images/list_evolution1.png)
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](lab1-intro.html "SO2 Lab 01 - Introduction") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](lab3-device-drivers.html "SO2 Lab 03 - Character device drivers")
