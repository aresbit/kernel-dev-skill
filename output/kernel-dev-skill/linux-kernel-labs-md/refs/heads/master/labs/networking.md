  ...
  - [Networking](#)
      ...
      - [Linux networking](#linux-networking)
          - [The `struct socket` structure](#the-struct-socket-structure)
              - [Operations on the socket structure](#operations-on-the-socket-structure)
              - [The `struct socket` fields](#the-struct-socket-fields)
...
<div role="navigation" aria-label="Page navigation">
  ...
  - [](../index.html)
  - Networking
  - [View page source](../_sources/labs/networking.rst.txt)
...
The source TCP port is, in the TCP header, in the [network byte-order](http://en.wikipedia.org/wiki/Endianness#Endianness_in_networking) format. Read through the [<span class="std std-ref">Conversions</span>](../so2/lab10-networking.html#conversions) section. Use `ntohs()` to convert.
...
To implement the ioctl routine, you must fill out the `my_ioctl` function. Review the section in [<span class="std std-ref">ioctl</span>](../so2/lab3-device-drivers.html#ioctl). The address sent from user space is in [network byte-order](http://en.wikipedia.org/wiki/Endianness#Endianness_in_networking), so there will be **NO need** for conversion.
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](filesystems_part2.html "File system drivers (Part 2)") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](arm_kernel_development.html "Kernel Development on ARM")
