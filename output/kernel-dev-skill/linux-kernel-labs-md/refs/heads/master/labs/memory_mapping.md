...
<div role="navigation" aria-label="Page navigation">
  ...
  - [](../index.html)
  - Memory mapping
  - [View page source](../_sources/labs/memory_mapping.rst.txt)
...
<div id="memory-mapping" class="section">

# Memory mapping[¶](#memory-mapping "Permalink to this headline")
...
[![../\_images/paging.png](../_images/paging.png)](../_images/paging.png)
...
[![../\_images/kernel-virtmem-map.png](../_images/kernel-virtmem-map.png)](../_images/kernel-virtmem-map.png)
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](arm_kernel_development.html "Kernel Development on ARM") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](device_model.html "Linux Device Model")
