  ...
  - [I/O access and Interrupts](#)
      ...
      - [Exercises](#exercises)
          ...
          - [3. Store ASCII keys to buffer](#store-ascii-keys-to-buffer)
              - [Reading the data register](#reading-the-data-register)
              - [Interpreting the scancode](#interpreting-the-scancode)
              - [Store characters to the buffer](#store-characters-to-the-buffer)
...
<div role="navigation" aria-label="Page navigation">
  ...
  - [](../index.html)
  - I/O access and Interrupts
  - [View page source](../_sources/labs/interrupts.rst.txt)
...
<div id="i-o-access-and-interrupts" class="section">

# I/O access and Interrupts[¶](#i-o-access-and-interrupts "Permalink to this headline")
...
[<span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous](device_drivers.html "Character device drivers") [Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span>](deferred_work.html "Deferred work")
